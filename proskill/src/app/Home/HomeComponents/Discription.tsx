...
function Discription() { 
  ...
  const text =
`"ProSkill – Best skill academy in Kerala | Resin art course in Kerala with expert guidance, hands-on training, and personalized support to build creativity and confidence."`;
